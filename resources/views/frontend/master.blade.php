    ...
    <div class="container">
        <div class="row">
            <div class="col-12">
                <nav class="main-nav">
                    <!-- ***** Logo Start ***** -->
                    <a href="master.blade" class="logo">
                        <h1>Penginapan</h1>
                    </a>
                    <!-- ***** Logo End ***** -->
                    <!-- ***** Menu Start ***** -->
                    <ul class="nav">
                      <li><a href="master.blade" class="active">Home</a></li>
    ...
    <div class="owl-carousel owl-banner">
      <div class="item item-1">
        <div class="header-text">
          <span class="category">Sananwetan <em>BLITAR</em></span>
          <h2>Penginapan Syariah<br>ANTI ZINA</h2>
        </div>
      </div>
      </div>
    </div>
